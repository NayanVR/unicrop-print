<x-app-layout>
    ...
    <div style="background:#fff;border:1.5px solid #E5E5E5;border-radius:14px;padding:28px;max-width:600px;">
        <form method="POST" action="{{ route('uploader.store') }}" enctype="multipart/form-data"
            ...
            {{-- Submit / Pick Files --}}
            <label for="file-picker" x-show="fileList.length === 0"
                style="display:flex;align-items:center;justify-content:center;gap:8px;width:100%;box-sizing:border-box;background:#F05A28;color:#fff;font-family:'DM Sans',sans-serif;font-size:14px;font-weight:700;border:none;border-radius:10px;padding:14px;cursor:pointer;transition:background 0.15s;"
            ...
            <button type="submit" x-show="fileList.length > 0"
